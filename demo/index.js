(function () {
    ...
    */
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            tourStepRenderParams = {
                                ...
                                prev: function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                this.currentStepIndex = stepIndex - 1;
    ...
    t.add({
        elements: ['.q2'],
        before: function () { return new Promise(function (r) { return setTimeout(r, 1000); }); },
        data: 'step2'
    });
    t.add({
        elements: ['.q3'],
    ...
    t.add({
        elements: ['.q1', '.q2'],
        before: function () {
            return new Promise(function (r) { return setTimeout(r, 500); });
        },
        data: 'step4',
        popperOptions: {}
    });
